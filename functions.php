...
function bootstrap2wordpress_scripts() {
	wp_enqueue_style( 'bootstrap2wordpress-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'bootstrap2wordpress-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
